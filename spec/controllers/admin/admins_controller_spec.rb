...
describe Admin::AdminsController do
  ...
  describe "GET index" do
    it "assigns all admin_admins as @admin_admins" do
      ...
      assigns(:admin_admins).should eq([admin])
    end
  end
  ...
  describe "GET show" do
    it "assigns the requested admin_admin as @admin_admin" do
      ...
      assigns(:admin_admin).should eq(admin)
    end
  end
  ...
  describe "GET new" do
    it "assigns a new admin_admin as @admin_admin" do
      ...
      assigns(:admin_admin).should be_a_new(Admin::Admin)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created admin_admin as @admin_admin" do
        post :create, {:admin_admin => valid_attributes}, valid_session
        assigns(:admin_admin).should be_a(Admin::Admin)
        assigns(:admin_admin).should be_persisted
      end

      it "redirects to the created admin_admin" do
        post :create, {:admin_admin => valid_attributes}, valid_session
        response.should redirect_to(Admin::Admin.last)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved admin_admin as @admin_admin" do
        ...
        Admin::Admin.any_instance.stub(:save).and_return(false)
        post :create, {:admin_admin => {  }}, valid_session
        assigns(:admin_admin).should be_a_new(Admin::Admin)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested admin_admin" do
        admin = Admin::Admin.create! valid_attributes
        # Assuming there are no other admin_admins in the database, this
        # specifies that the Admin::Admin created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        Admin::Admin.any_instance.should_receive(:update).with({ "these" => "params" })
        put :update, {:id => admin.to_param, :admin_admin => { "these" => "params" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the admin_admin as @admin_admin" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Admin::Admin.any_instance.stub(:save).and_return(false)
        put :update, {:id => admin.to_param, :admin_admin => {  }}, valid_session
        assigns(:admin_admin).should eq(admin)
      end
